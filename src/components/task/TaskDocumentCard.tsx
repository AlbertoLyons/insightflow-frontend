...
import TaskDetailsModal from './TaskCardById';
    ...
    return (
        <>
            <div 
                ...
                className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md hover:bg-gray-50 transition-all cursor-pointer"
            >
