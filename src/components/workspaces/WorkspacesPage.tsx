...
export default function WorkspacesPage() {
  ...
  async function handleSearchWorkspace(id: string) {
    ...
    try {
      ...
      const formattedDate = new Date(workspace.createdAt).toLocaleString(
        "es-CL",
        {
          day: "2-digit",
          month: "2-digit",
      ...
      alert(
        "Error al buscar el espacio de trabajo. Por favor, verifique el ID e intente nuevamente."
      );
      return;
    }
      ...
      {showSearchModal && (
        ...
        >
          ...
          >
            ...
            >
              <h3 style={{ color: "#001b5aff", fontWeight: "bold" }}>
                Buscar espacio de trabajo
              </h3>
              <button
